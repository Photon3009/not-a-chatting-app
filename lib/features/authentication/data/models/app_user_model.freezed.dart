...
class _$AppUserImpl implements _AppUser {
  const _$AppUserImpl(
      ...
      @JsonKey(includeIfNull: false) final List<String>? challenges,
      this.avatar})
  ...
  @override
  String toString() {
    return 'AppUser(id: $id, name: $name, email: $email, phone: $phone, challenges: $challenges, avatar: $avatar)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, phone,
      const DeepCollectionEquality().hash(_challenges), avatar);
