...
import 'package:its_urgent/features/app/data/api_client.dart';
import 'package:its_urgent/features/authentication/data/models/app_user_model.dart';
import 'package:its_urgent/utils/utils.dart';
...
class AuthCubit extends HydratedCubit<AuthState> with CubitMaybeEmit {
  ...
  Future<void> updateChallenge({required List<String>? challenges}) async {
    final user = state.user;
    ...
    if (user == null) {
      ...
      AppUser updatedUser = user.copyWith(challenges: challenges);
