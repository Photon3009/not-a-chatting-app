...
class _$ChallengeImpl implements _Challenge {
  const _$ChallengeImpl({required this.question, required this.answer});
  ...
  @override
  String toString() {
    return 'Challenge(question: $question, answer: $answer)';
  }
...
abstract class _Challenge implements Challenge {
  const factory _Challenge(
      ...
      required final String answer}) = _$ChallengeImpl;
