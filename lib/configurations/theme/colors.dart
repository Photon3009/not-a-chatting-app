...
class AppColors {
  ...
  static const Color secondary = Color(0xffBFBFBF);
  static const Color onSecondary = Colors.black;
  static const Color secondaryContainer = Color(0xffFD4930);
  ...
  static const Color primaryContainerDark = Colors.black;
